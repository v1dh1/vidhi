...
const Projects = () => {
  return (
    ...
    <div className='relative z-20 flex justify-center w-full'>
      ...
      <div className="p-4 bg-gradient-to-br from-stone-700 to-stone-950 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {/* Grid Item 1 */}
            <div className=" p-6">
            <h2 className="font-semibold text-3xl mb-2 text-fuchsia-100 font-sofia">Work</h2>
