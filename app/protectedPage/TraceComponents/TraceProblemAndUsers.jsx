...
const TraceProblemAndUsers = () => {
  return (
    <div>
        ...
        <div className='text-stone-400 text-l pt-8'>Problem and Users</div>

        <div className='text-stone-200 text-xl font-bold'>{"Shifting Toward a 'Local-First' Focus: Empowering Sustainable Shopping and Small Businesses in the TD Ecosystem"}</div>
        ...
        <div className='text-stone-200 pt-4 pb-2'>Who Are The Users for Trace?</div>

        <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>

            <div className='bg-stone-700 p-4 rounded-xl border-2 border-stone-600'>

                <div className='text-stone-200 text-xl font-bold'>{"TD Customers interested in sustainable living"}</div>
            ...
            <div className='bg-stone-700 p-4 rounded-xl border-2 border-stone-600'>
                ...
                <div className='text-stone-200 text-xl font-bold'>{"Internal Stakeholders to obtain buy-in from"}</div>
                    <div className='text-stone-300'>
            ...
            <div className='bg-stone-700 p-4 rounded-xl border-2 border-stone-600'>
                ...
                <div className='text-stone-200 text-xl font-bold'>{"Local-Oriented Individuals who value community connection"}</div>
                    <div className='text-stone-300'>
