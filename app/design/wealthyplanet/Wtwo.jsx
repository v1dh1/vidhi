...
<a
  href="#takeaways"
  className="rounded-lg bg-fuchsia-800 border-2 border-stone-300 text-stone-100 
...
<div className="w-full md:w-1/2 mx-auto p-8 md:p-0">
     ...
     <div className='text-fuchsia-800 text-2xl pb-4'>Context</div>
...
<div className='w-full md:w-1/2 mx-auto pt-8 md:pt-16 p-8 md:p-0'>
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div className='text-fuchsia-800 text-2xl pb-4'>Understanding the Space</div>
            <div className='text-stone-700 text-base'>{"WealthyPlanet had a"} <span className='text-fuchsia-700 font-bold'>trustability</span> {"problem. The existing website lacked clarity, engaging content, and essential functionality."}</div>
...
<div className="w-full md:w-1/2 mx-auto pt-8 md:pt-24 p-8 md:p-0">
     ...
     <div className='text-fuchsia-800 text-2xl pb-4'>Competitive Analysis</div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8">
            ...
            <div className='text-fuchsia-700 text-xl'>Insight</div>

            <div className='text-fuchsia-700 text-xl'>Design Implication</div>
        </div>
