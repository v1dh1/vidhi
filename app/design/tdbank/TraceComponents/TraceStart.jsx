...
<div className='w-full md:w-1/2 mx-auto pt-8 md:pt-16 p-8 md:p-0'>
    ...
    <div className='border-l-4 border-fuchsia-800 p-2 text-stone-700 text-base'>{"Users were more motivated by local relevance and tangible rewards than abstract sustainability benefits."}</div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div>
            ...
            <div className='text-fuchsia-800 text-2xl pb-4'>Key Challenges Identified</div>
