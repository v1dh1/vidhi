  ...
  return (
    <div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-4 gap-4 pt-4'>
            ...
            <div className='text-stone-600 bg-fuchsia-50 p-4 rounded-xl'>{"The user flow creation process facilitated a clear understanding of user interactions and navigation paths within the app, enabling stakeholders to visualize and evaluate the user experience from end to end."}</div>
            <div className='text-stone-600 bg-fuchsia-50 p-4 rounded-xl'>{"User flow diagrams served as valuable communication tools, fostering alignment among team members and stakeholders regarding the app's functionality and usability requirements."}</div>
            <div className='text-stone-600 bg-fuchsia-50 p-4 rounded-xl'>{"Key findings from user flow analysis informed iterative design decisions, guiding subsequent iterations of wireframes and prototypes to better align with user needs and project objectives"}</div>
            <div className='text-stone-600 bg-fuchsia-50 p-4 rounded-xl'>{"These newly integrated designs will be demo-ed to the Small Business team at TD, to hopefully get approval to move forward and integrate this in the app"}</div>
        </div>
        ...
        <div className='text-fuchsia-400 font-bold pt-12 pb-4'>Next Steps</div>
        ...
        <div className='text-center text-fuchsia-900 pt-10 pb-8'>{"A special thanks to Meghna Bellani for mentoring and guiding me through this project, and as a designer <3"}</div>
    </div>
  )
}
