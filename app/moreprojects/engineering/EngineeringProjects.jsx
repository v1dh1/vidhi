...
const EngineeringProjects = () => {
  return (
    <div>
      ...
      <p className='text-4xl md:text-6xl text-stone-700 font-semibold pt-4 pb-2'>{"More Projects!"}</p>
      <p className='text-xl text-stone-600 pb-6'>{"Outside of product design, here are some other things I've worked on"}</p>
